...
template <typename Tag, typename Data = ::beman::execution26::detail::make_sender_empty, typename... Child>
    requires ::std::semiregular<Tag> && ::beman::execution26::detail::movable_value<Data> &&
             (::beman::execution26::sender<Child> && ...)
constexpr auto make_sender(Tag tag, Data&& data, Child&&... child) {
    return ::beman::execution26::detail::basic_sender<Tag, ::std::decay_t<Data>, ::std::decay_t<Child>...>{
