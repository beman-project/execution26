    ...
    {   
        ...
        auto operator()(Sender&& sender, Scheduler&& scheduler) const
        {
            ...
            return ::beman::execution26::transform_sender(
                domain,
                ::beman::execution26::detail::make_sender(*this,  scheduler, ::std::forward<Sender>(sender))
            );
        }
    };

    template<>
    struct impls_for<::beman::execution26::detail::continues_on_t>
        : ::beman::execution26::detail::default_impls
    {
        static constexpr auto get_attrs{
            [](auto const& data, auto const& child) noexcept -> decltype(auto)
            {
