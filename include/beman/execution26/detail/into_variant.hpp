...
struct into_variant_t {
    ...
    auto operator()(Sender&& sender) const {
        ...
        (void)domain;
        return ::beman::execution26::detail::make_sender(*this, {}, ::std::forward<Sender>(sender));
...
template <>
struct impls_for<::beman::execution26::detail::into_variant_t> : ::beman::execution26::detail::default_impls {
    static constexpr auto get_state = []<typename Sender, typename Receiver>(Sender&&, Receiver&&) noexcept
        -> ::std::type_identity<
            ::beman::execution26::value_types_of_t<::beman::execution26::detail::child_type<Sender>,
                                                   ::beman::execution26::env_of_t<Receiver>>> { return {}; };
...
struct completion_signatures_for_impl<
    ::beman::execution26::detail::basic_sender<::beman::execution26::detail::into_variant_t, State, Sender>,
    Env> {
    ...
    using value_types  = ::std::conditional_t<
         ...
         ::beman::execution26::completion_signatures<::beman::execution26::set_value_t(variant_type)>>;
    template <typename... E>
    using make_error_types = ::beman::execution26::completion_signatures<::beman::execution26::set_error_t(E)...>;

    using error_types = ::beman::execution26::error_types_of_t<Sender, Env, make_error_types>;
    using stopped_types =
        ::std::conditional_t<::beman::execution26::sends_stopped<Sender, Env>,
                             ::beman::execution26::completion_signatures<::beman::execution26::set_stopped_t()>,
                             ::beman::execution26::completion_signatures<>>;
    using type = ::beman::execution26::detail::meta::
        combine<value_types, ::beman::execution26::detail::meta::combine<error_types, stopped_types>>;
};
} // namespace beman::execution26::detail
