...
struct let_t {
    ...
    static auto env(Sender&& sender) {
        if constexpr (requires {
            ...
            return ::beman::execution26::detail::sched_env(
                ::beman::execution26::get_completion_scheduler<Completion>(::beman::execution26::get_env(sender)));
        else if constexpr (requires {
                               ::beman::execution26::detail::make_env(
                                   ::beman::execution26::get_domain,
                                   ::beman::execution26::get_domain(::beman::execution26::get_env(sender)));
                           })
    ...
    static auto join_env(Sender&& sender, Env&& e) -> decltype(auto) {
        return ::beman::execution26::detail::join_env(env(sender), ::beman::execution26::detail::fwd_env(e));
    }
};

template <typename Completion>
struct impls_for<::beman::execution26::detail::let_t<Completion>> : ::beman::execution26::detail::default_impls {
    ...
    struct let_receiver {
        ...
        auto get_env() const noexcept -> decltype(auto) {
            return ::beman::execution26::detail::join_env(
                this->env, ::beman::execution26::detail::fwd_env(::beman::execution26::get_env(this->receiver)));
        }
        template <typename Error>
        auto set_error(Error&& error) && noexcept -> void {
            ::beman::execution26::set_error(::std::move(this->receiver), ::std::forward<Error>(error));
        }
        auto set_stopped() && noexcept -> void { ::beman::execution26::set_stopped(::std::move(this->receiver)); }
    ...
    struct to_state {
        ...
        using trans =
            decltype(::beman::execution26::connect(::std::apply(::std::declval<Fun>(), ::std::declval<Tuple>()),
    ...
    static constexpr auto get_state{[]<typename Sender, typename Receiver>(Sender&& sender, Receiver&& receiver) {
        ...
        using sigs_t =
            ::beman::execution26::completion_signatures_of_t<child_t, ::beman::execution26::env_of_t<Receiver>>;
        ...
        using ops_t       = ::beman::execution26::detail::meta::prepend<
                  ::std::monostate,
                  ::beman::execution26::detail::meta::unique<::beman::execution26::detail::meta::transform<
        ...
        return state_t{beman::execution26::detail::allocator_aware_move(
                           ::beman::execution26::detail::forward_like<Sender>(fun), receiver),
...
struct completion_signatures_for_impl<
    ::beman::execution26::detail::basic_sender<::beman::execution26::detail::let_t<Completion>, Fun, Sender>,
    Env> {
    template <typename>
    ...
    struct get_completions<L<C...>> {
        using type = ::beman::execution26::detail::meta::unique<
            ::beman::execution26::detail::meta::combine<decltype(::beman::execution26::get_completion_signatures(
                std::declval<typename apply_decayed<C>::sender_type>(), std::declval<Env>()))...>>;
    };

    using upstream_env = decltype(::beman::execution26::detail::let_t<Completion>::join_env(::std::declval<Sender>(),
                                                                                            ::std::declval<Env>()));
    ...
    using other_completions    = ::beman::execution26::detail::meta::filter<other_completion, upstream_completions>;
    using matching_completions = ::beman::execution26::detail::meta::filter<matching_completion, upstream_completions>;
    using type = ::beman::execution26::detail::meta::combine<typename get_completions<matching_completions>::type,
                                                             other_completions>;
};
} // namespace beman::execution26::detail
