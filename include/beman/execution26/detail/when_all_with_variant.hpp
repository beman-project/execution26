...
struct when_all_with_variant_t {
    ...
    auto transform_sender(Sender&& sender, auto&&...) const noexcept {
        return ::std::forward<Sender>(sender).apply([](auto&&, auto&&, auto&&... child) {
            return ::beman::execution26::when_all(
                ::beman::execution26::into_variant(::beman::execution26::detail::forward_like<Sender>(child))...);
        });
    }
    ...
    auto operator()(Sender&&... sender) const {
        ...
        return ::beman::execution26::transform_sender(
            domain_t{}, ::beman::execution26::detail::make_sender(*this, {}, ::std::forward<Sender>(sender)...));
    }
};
} // namespace beman::execution26::detail
