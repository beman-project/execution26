...
namespace beman::execution26::detail
{
    ...
    {
        template <
            ::beman::execution26::detail::sender_for<::beman::execution26::detail::starts_on_t> Sender,
            typename Env>
        auto transform_env(Sender&& sender, Env&& env) const noexcept
        {
            ...
            return ::beman::execution26::detail::join_env(
                ::beman::execution26::detail::sched_env(scheduler),
        ...
        auto transform_sender(Sender&& sender, Env&&...) const noexcept
        {
            ...
            return ::beman::execution26::let_value(
                ...
                [new_sender = ::beman::execution26::detail::forward_like<Sender>(new_sender)]()
                    mutable noexcept(::std::is_nothrow_constructible_v<::std::decay_t<Sender>>)
                {
